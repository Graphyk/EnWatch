    ...
    <div class='flex items-center'>
        <a href='/ENWATCH' class='flex items-center'>
            ...
            <div id='burgerMenu' class='translate-x-[100%] md:translate-x-[0px] bg-[#1CD4E1] md:flex flex-col items-end top-[8.7%] hidden  md:z-auto absolute right-0 md:static text-[12px]  lg:text-[24px] flex md:flex-row ml-[50px] gap-[30px]'>
                ...
                <div id='dropmenu2' class='-z-10  -translate-y-[300%] bg-[#643CCE] w-[15vw] md:w-[20vw] flex items-center absolute top-[45.5px] -left-[12vw] md:-left-[8.5vw] text-[8px] md:text-[12px]'>
                ...
                <div id='dropmenu3' class='-z-10 -translate-y-[300%] bg-[#643CCE] w-[20vw] flex items-center absolute top-[45.5px] -left-[12vw] md:-left-[8.5vw] text-[8px] md:text-[16px]'>
