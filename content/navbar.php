<navbar class='bg-[#1CA4E1]  h-[45px] pl-[20px] sticky top-[0] z-[999] inline-block flex justify-between items-center font-[MuseoModerno] '>
    <div class='flex items-center md:w-full'>
        ...
        <div id='burgerMenu' class='translate-x-[100%] h-[100vh] md:justify-between md:w-full md:h-auto z-20 md:translate-x-[0px] ease-out bg-[#1CA4E1] md:flex flex-col items-end top-[8.7%] hidden  md:z-auto fixed right-0 md:static text-[12px]  lg:text-[24px] flex md:flex-row ml-[50px] gap-[30px]'>
            <div class='flex flex-col md:flex-row gap-[30px] items-end'>
            ...
            if (isset($_SESSION["connected"])){
                echo"
                    <a class='flex items-end text-[12px]'>
