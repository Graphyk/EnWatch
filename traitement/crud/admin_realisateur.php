...
<div class='w-full overflow-auto'>
    <table class='mx-auto'>
        ...
        <?php
        while ($row = $real->fetch(PDO::FETCH_NUM, PDO::FETCH_ORI_NEXT)){
            $i=0;
            echo"
            <tr>";
            for ($i;$i<4;$i++){
        ...
        <tr>
            ...
            <tr>
                <td class='px-10 py-5 border border-black border-solid text-center'><?php $last+=1;
                                                                                        echo "$last" ?></td>
                <td class='px-10 py-5 border border-black border-solid text-center'><input type='text' name='nom_real' placeholder="Nom du réalisateur"></td>
                <td class='px-10 py-5 border border-black border-solid text-center'><input type='text' name='prenom_real' placeholder="prénom du réalisateur"></td>
