<form action='traitement_conn.php' method='post' class='flex flex-col items-center bg-[#F9F9F9] rounded-[10px] pt-[10px] lg:pt-[20px] pb-[20px] lg:pb-[40px] w-[200px] md:w-[400px] lg:w-[500px] font-[Kodchasan] mx-auto my-[20%]'>
